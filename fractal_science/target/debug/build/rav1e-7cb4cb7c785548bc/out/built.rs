...
#[allow(dead_code)]
pub const RUSTC: &str = r"/Users/lukashalza/.cargo/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/Users/lukashalza/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/lukashalza/.cargo/bin/rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.83.0 (90b35a623 2024-11-26)";
#[doc=r#"The output of `/Users/lukashalza/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/lukashalza/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
