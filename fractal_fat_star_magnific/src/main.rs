...
impl FractalNebulaCommon for FatStarMagnific<'_> {
...
pub static FRACTAL: Mutex<Option<FatStarMagnific>> = Mutex::new(None);
...
impl FractalApplication for FatStarMagnific<'_> {
...
mod tests {
    ...
    #[test]
    fn test_math() {
        let fat_star_magnific = FatStarMagnific { app: application::init_none() };
